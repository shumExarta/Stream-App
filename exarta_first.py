    ...
    st.markdown(
        ...
        <div class="main-card">
            ...
            <div class="row">
                ...
                <p>{int(exarta_youtube['today_followers'])}</p>
            </div>
            <div class="row">
                <p>Yesterday's Follower Gain</p>
                <p>{int(exarta_youtube['yesterday_followers'])}</p>
            </div>
            <div class="row">
                <p>Total Followers</p>
                <p>{int(exarta_youtube['total_followers'])}</p>
            </div>
        </div>
        """, unsafe_allow_html=True
    )
...
with col2:
    st.markdown(
        ...
        <div class="main-card">
            ...
            <div class="row">
                <p>Today's Follower Gain</p>
                <p>{int(exarta_x['today_followers'])}</p>
            </div>
            <div class="row">
                <p>Yesterday's Follower Gain</p>
                <p>{int(exarta_x['yesterday_followers'])}</p>
            </div>
            <div class="row">
                <p>Total Followers</p>
                <p>{int(exarta_x['total_followers'])}</p>
            </div>
        </div>
        """, unsafe_allow_html=True
    )
...
with col3:
    st.markdown(
        ...
        <div class="main-card">
            ...
            <div class="row">
                <p>Today's Follower Gain</p>
                <p>{int(exarta_facebook['today_followers'])}</p>
            </div>
            <div class="row">
                <p>Yesterday's Follower Gain</p>
                <p>{int(exarta_facebook['yesterday_followers'])}</p>
            </div>
            <div class="row">
                <p>Total Followers</p>
                <p>{int(exarta_facebook['total_followers'])}</p>
            </div>
        </div>
        """, unsafe_allow_html=True
    )
...
with col4:
    st.markdown(
        ...
        <div class="main-card">
            ...
            <div class="row">
                <p>Today's Follower Gain</p>
                <p>{int(exarta_linkedin['today_followers'])}</p>
            </div>
            <div class="row">
                <p>Yesterday's Follower Gain</p>
                <p>{int(exarta_linkedin['yesterday_followers'])}</p>
            </div>
            <div class="row">
                <p>Total Followers</p>
                <p>{int(exarta_linkedin['total_followers'])}</p>
            </div>
        </div>
        """, unsafe_allow_html=True
    )
...
with col5:
    st.markdown(
        ...
        <div class="main-card">
            ...
            <div class="row">
                <p>Today's Follower Gain</p>
                <p>{int(exarta_instagram['today_followers'])}</p>
            </div>
            <div class="row">
                <p>Yesterday's Follower Gain</p>
                <p>{int(exarta_instagram['yesterday_followers'])}</p>
            </div>
            <div class="row">
                <p>Total Followers</p>
                <p>{int(exarta_instagram['total_followers'])}</p>
            </div>
        </div>
        """, unsafe_allow_html=True
    )
